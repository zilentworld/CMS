	...
	<s:div>
		<s:div
            ...
            You have picked the template: <s:property
					value="cmsTemplates.templateName" />
			</s:div>
			<s:div class="register border">
            	...
            	<s:div style="margin: 2%;">
						<s:form action="processRegister" method="post">
							...
							<s:hidden name="cmsUserType" value="cms_admin" />
							<s:hidden name="cmsTemplateId" value="%{cmsTemplates.templateId}" />
							<s:textfield label="Username" placeholder="Username" name="cmsUser.cmsUsername" />
							<s:textfield label="Password" type="password" placeholder="Password" name="cmsUser.cmsPassword" />
			...
			<s:div class="login border">
            	...
            	Or login in on your account
	            	<s:div style="margin: 2%;">
<!-- 						<s:form> -->
<!-- 							<s:textfield label="Username" placeholder="Username" /> -->
<!-- 							<s:textfield label="Password" placeholder="Password" type="password" /> -->
